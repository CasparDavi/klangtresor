...
const SIGMA_ANTEIL = 0.08;       // massive Unschaerfe: sigma bis 8 % der Bildbreite
...
// Zusammensetzen
const GES = LOOPS * P, ziel = `${OUT}/glut-ruecklauf.mp4`;
...
const mittePng = `${OUT}/glut-ruecklauf-mitte.png`;
...
fs.writeFileSync(`${HIER}/ruecklauf.json`, JSON.stringify(bericht, null, 1));
